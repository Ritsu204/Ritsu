...
public class PlayConroll2 {
	...
	public static void main(String[] args) {
		...
		**/
		...
		int mord = stdIn.nextInt();

		while (mord != 0 && mord != 99) {
			System.out.println("0か99で選んでね");
			mord = stdIn.nextInt();
		}

		if (mord == 99) {
			System.out.println("主人公のステータス再設定");
			...
			System.out.println("ヒロインのステータス再設定");
